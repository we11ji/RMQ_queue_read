...
# servers parameters
rmq_server = {'server': 'srv8-cabro.net.billing.ru', 'vhost': 'ufm_8.15.0', 'user': 'admin', 'password': 'admin', 'port': 5672}
...
def task_10(connection, channel):  # ps.kit_add создание клиента/абона
    ...
    dirname = os.path.dirname(os.path.abspath(__file__))
    props = pika.BasicProperties(content_type='application/json',
                                 headers={'application': 'UFM', 'version': '1.2', 'eventDate': '2020-03-29T04:36:21'},
                                 delivery_mode=2,
                                 priority=0
                                 )
    ...
    msg = '{"customerId":11218931277,"customerInsertMethodId":4,"juralTypeId":1,"useMultipleBills":"true","customerType' \
          ...
          '"accountNumber":"5130569677","macroRegionId":500,"branchId":105,"registrationCategoryId":1,"contracts":' \
          '[{"contractId":121785479,"contractNumber":"GF0103663905","contractClassId":1,"contractStatusId":1,"expireDate":null,"isMain":true}]' \
          ',"subscribers":[{"subscriberId":121982377,"standardId":1,"subscriberStatusId":2,"identification":"9271168689","activationDate":"2020-03-02T08:18:16+03:00",' \
          ...
          '"productActionType":"ACTIVATE","activationDateTime":"2020-03-02T08:18:16+03:00","deactivationDateTime":null,"productServices":[],' \
          '"marketingCampaign":null,"compriseProducts":null},{"productId":15321857571,"productOfferingId":220,"productActionType"' \
          ':"ACTIVATE","activationDateTime":"2020-03-02T08:18:16+03:00","deactivationDateTime":null,"productServices":' \
          '[{"serviceId":2345924856,"serviceActionType":"ACTIVATE"}],"marketingCampaign":null,"compriseProducts":null},' \
          '{"productId":15321857572,"productOfferingId":250,"productActionType":"ACTIVATE","activationDateTime":"2020-03-02T08:18:16+03:00",' \
          '"deactivationDateTime":null,"productServices":[{"serviceId":2345924857,"serviceActionType":"ACTIVATE"}],"marketingCampaign":null,' \
          '"compriseProducts":null},{"productId":15321857573,"productOfferingId":251,"productActionType":"ACTIVATE","activationDateTime":"2020-03-02T08:18:16+03:00","deactivationDateTime":null,' \
          ...
          '"productActionType":"ACTIVATE","activationDateTime":"2020-03-02T08:18:16+03:00","deactivationDateTime":null,"productServices":[{"serviceId":2345924859,"serviceActionType":"ACTIVATE"}],' \
...
def task_24(connection, channel):
    ...
    dirname = os.path.dirname(os.path.abspath(__file__))
    date = int(time.time())
    Header = {'MSG_ID': '22965934731', 'version': '1.0', 'eventDate': '2020-03-17T13:13:28'}
    props = pika.BasicProperties(content_type='application/json',
                                 headers=Header,
                                 delivery_mode=2,
                                 priority=0,
    ...
    msg = '{"subscriberId":82958906,"operationDate":"2020-03-17T13:13:28","standartId":1,"subscriberStatusId":2,"identification":"","personalCustomerId":null,"activationDate":"2020-03-17T13:13:28","usePersonalBalanceDate":null,"currentZoneId":3}'
    msg = '{"customerId":70176159,"subscriberId":82958906,"operationDate":"2020-03-17T13:13:28","standartId":1,"subscriberStatusId":2,"identification":"","personalCustomerId":null,"activationDate":"2020-03-17T13:13:28","usePersonalBalanceDate":null,"currentZoneId":11}'
    channel.basic_publish(exchange, routing_key, msg, props)
    print(msg)
    connection.close()
...
def task_25(connection, channel):
    ...
    msg = '{"subscriberId":82958906,"operationDate":"2020-03-18T13:13:28","customerId":70176159,"standartId":1,"phoneNumber":"9312909769","ratePlanId":455,"recurringFlag":null,"activationDate":"2020-03-18T13:13:28","subscriberStatusId":2}'
    channel.basic_publish(exchange, routing_key, msg, props)
    print(msg)
    connection.close()

#
task_10(connection, channel)
